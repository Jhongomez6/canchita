        ...
        >
            <LayoutGroup>
                ...
                >
                    ...
                    {/* CONFIGURACIÓN (Location Admin Only) — activar notificaciones de sede */}
                    {isLocationAdminUser && (
                        <NavItem href="/admin/settings" active={pathname.startsWith("/admin/settings")} label="Configuración">
                            <NavIcon>
