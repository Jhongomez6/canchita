...
import { CheckCircle2, ChevronRight, Bell, Trophy, MessageSquare, CalendarClock, Users, Star, Award, Flag } from "lucide-react";
...
const TYPE_ICONS: Record<string, ReactNode> = {
    ...
    mvp_voting_open: <Trophy size={18} className="text-yellow-500" />,
    teams_confirmed: <Users size={18} className="text-emerald-600" />,
    post_match_review: <Star size={18} className="text-amber-400" />,
    kudo_received: <Award size={18} className="text-amber-500" />,
    report_reviewed: <Flag size={18} className="text-slate-500" />,
