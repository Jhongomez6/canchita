import { Heart, BarChart2, HelpCircle, Award } from "lucide-react";
...
export default function StatsCard({ stats, mvpAwards, kudosSummary, onViewKudosHistory }: StatsCardProps) {
    const commitmentScore = calcCommitmentScore(stats);
    const played = stats.played || 0;
    const won = stats.won || 0;
    const winRate = played > 0 ? Math.round((won / played) * 100) : 0;
    const hasKudos = !!kudosSummary && (kudosSummary.total ?? 0) > 0;
